...
import static hu.blackbelt.judo.tatami.psm2sdk.Psm2SDK.Psm2SDKParameter.psm2SDKParameter;
import static hu.blackbelt.judo.tatami.psm2sdk.Psm2SDK.executePsm2SDKGeneration;
import static hu.blackbelt.judo.tatami.psm2asm.Psm2Asm.executePsm2AsmTransformation;

@Slf4j
public class Psm2SDKOperationTest {
    ...
    public void testExecutePsm2SDKGeneration() throws Exception {
        Psm2SDKBundleStreams bundleStreams = executePsm2SDKGeneration(psm2SDKParameter()
                        .psmModel(psmModel)
