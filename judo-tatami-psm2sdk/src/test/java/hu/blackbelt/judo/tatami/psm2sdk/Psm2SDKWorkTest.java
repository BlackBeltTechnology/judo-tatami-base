...
public class Psm2SDKWorkTest {
    ...
    void setUp() throws Exception {
        ...
        psm2SDKWork = new Psm2SDKWork(transformationContext);
    ...
    void testSimpleWorkflow() throws IllegalArgumentException, IOException, AsmValidationException, PsmValidationException {
        WorkFlow workflow = aNewSequentialFlow().execute(psm2SDKWork).build();
