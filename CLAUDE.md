...
Prioritize LSP-based navigation (find definitions, references, and symbols) over 
string-based searching like grep. Only use read or grep if the LSP fails to resolve the symbol.
---
