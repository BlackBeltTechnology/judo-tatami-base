# expression-iterator-determinism Specification

## Purpose
Ensures that iterator variable names in expression building are deterministic per expression, regardless of ASM element extraction order.
