# keycloak-xmiid Specification

## Purpose
Ensures that asm2keycloak ETL and Zeta transformations produce deterministic, identical XMI IDs for Realm, Client, and AttributeBinding elements.
