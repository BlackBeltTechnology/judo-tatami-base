# zeta-parity Specification

## Purpose
Ensures Zeta transformation rules produce output identical to ETL, including documentation annotations, XMI ID suffixes, and API usage patterns.
