...
/**
 * Tests for {@link ExpressionValidationOnAsmZetaWork}.
 */
@Slf4j
class ExpressionValidationOnAsmZetaWorkTest {

    public static final String NORTHWIND = "northwind";

    TransformationContext transformationContext;
    ExpressionValidationOnAsmZetaWork expressionValidationOnAsmZetaWork;
    ...
    void setUp() throws Exception {
        ...
        expressionValidationOnAsmZetaWork = new ExpressionValidationOnAsmZetaWork(transformationContext);
    }

    @Test
    void testSimpleWorkflow() {
        WorkFlow workflow = aNewSequentialFlow().execute(expressionValidationOnAsmZetaWork).build();
