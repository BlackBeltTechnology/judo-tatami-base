...
/**
 * Tests for {@link AsmValidationZetaWork}.
 */
@Slf4j
class AsmValidationZetaWorkTest {

    public static final String NORTHWIND = "northwind";

    TransformationContext transformationContext;
    AsmValidationZetaWork asmValidationZetaWork;
    ...
    void setUp() throws Exception {
        ...
        asmValidationZetaWork = new AsmValidationZetaWork(transformationContext);
    }

    @Test
    void testSimpleWorkflow() {
        WorkFlow workflow = aNewSequentialFlow().execute(asmValidationZetaWork).build();
