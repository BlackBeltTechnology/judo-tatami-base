...
/**
 * Tests for {@link ExpressionValidationOnPsmZetaWork}.
 */
@Slf4j
class ExpressionValidationOnPsmZetaWorkTest {

    public static final String NORTHWIND = "northwind";

    TransformationContext transformationContext;
    ExpressionValidationOnPsmZetaWork expressionValidationOnPsmZetaWork;
    ...
    void setUp() throws Exception {
        ...
        // Create ASM model from PSM
        AsmModel asmModel = buildAsmModel().build();
        executePsm2AsmTransformation(psm2AsmParameter()
                .psmModel(psmModel)
                .asmModel(asmModel));

        // Create Measure model from PSM
        ...
        // Create Expression model from ASM
        ...
        expressionValidationOnPsmZetaWork = new ExpressionValidationOnPsmZetaWork(transformationContext);
    }

    @Test
    @Disabled("Northwind demo has ObjectTypeIsValid validation error - matches EVL test behavior")
    void testSimpleWorkflow() {
        WorkFlow workflow = aNewSequentialFlow().execute(expressionValidationOnPsmZetaWork).build();
